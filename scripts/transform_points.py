...
class TranformPoints(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Marker,
                                 'people_marker',
                                 self.people_marker_callback,
                                 qos_profile_sensor_data)

        self.robot_frame_point_position = None

    def people_marker_callback(self, msg):
        self.robot_frame_point_position = msg.pose.position
        ...
        point_in_robot_frame.point.x = self.robot_frame_point_position.x
        point_in_robot_frame.point.y = self.robot_frame_point_position.y
        point_in_robot_frame.point.z = self.robot_frame_point_position.z
        ...
        try:
            ...
            self.get_logger().info(
                f"The marker has been published to /breadcrumbs. You are able to visualize it in Rviz")
